...
import (
	...
	blog1module "blog1/x/blog1"
	blog1modulekeeper "blog1/x/blog1/keeper"
	blog1moduletypes "blog1/x/blog1/types"
...
type App struct {
	*baseapp.BaseApp
	...
	Blog1Keeper blog1modulekeeper.Keeper
...
func New(
	...
	app.Blog1Keeper = *blog1modulekeeper.NewKeeper(
		appCodec,
		keys[blog1moduletypes.StoreKey],
		keys[blog1moduletypes.MemStoreKey],
		app.GetSubspace(blog1moduletypes.ModuleName),
	)
	blog1Module := blog1module.NewAppModule(appCodec, app.Blog1Keeper, app.AccountKeeper, app.BankKeeper)
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey sdk.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(blog1moduletypes.ModuleName)
